/********************************** (C) COPYRIGHT *******************************
 * File Name          : _bt_driver.h (access.h)
 * Author             : tech7 / Keychron
 * Version            : V1.0
 * Date               : 2023/03/06
 * Description        : CH584 蓝牙驱动内部头文件 - 定义内部状态和常量
 *******************************************************************************/
...
// 外设回调函数声明（需要在其他地方实现）
extern void peripheral_disconnected_cb(void);
extern void peripheral_connected_cb(void);
extern void peripheral_pairing_cb(void);
extern void peripheral_connecting_cb(void);
extern void peripheral_pilot_led_receive(uint8_t data);
extern void peripheral_enter_sleep(void);
